...
export default function Next() {
  ...
  const className = `${classes[`pagination-next`]} ${classes["pagination-button"]}`
  return (
    <button
      className={className}
      onClick={paginationContext.onNextPage}
      disabled={paginationContext.maxPage === paginationContext.currentPage}
    >
